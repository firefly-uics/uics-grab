...
/**
* Created by tom on 2016-12-07 10:55:17.
 */
public class IdcsNotificationRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(IdcsNotificationRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/idcsnotifications";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<IdcsNotification>> result = (RestResult<List<IdcsNotification>>)restResult;
                ...
                LOGGER.info("IdcsNotification list:{}", JSON.toJSON(restResult));
            }
        }, URL, IdcsNotificationRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final IdcsNotification idcsNotification = new IdcsNotification();
////        idcsNotification.set*("*");
//
//        Response response = getBuilder(URL, idcsNotificationRestClient.TOKEN).post(Entity.entity(idcsNotification, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
