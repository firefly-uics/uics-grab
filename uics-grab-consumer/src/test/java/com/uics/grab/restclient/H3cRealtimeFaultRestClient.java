 ...
 */
public class H3cRealtimeFaultRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(H3cRealtimeFaultRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/h3crealtimefaults";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<H3cRealtimeFault>> result = (RestResult<List<H3cRealtimeFault>>)restResult;
                ...
                LOGGER.info("H3cRealtimeFault list:{}", JSON.toJSON(restResult));
            }
        }, URL, H3cRealtimeFaultRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final H3cRealtimeFault h3cRealtimeFault = new H3cRealtimeFault();
////        h3cRealtimeFault.set*("*");
//
//        Response response = getBuilder(URL, h3cRealtimeFaultRestClient.TOKEN).post(Entity.entity(h3cRealtimeFault, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
