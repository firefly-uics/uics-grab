 ...
 */
public class VrvConfigRestClient extends RestClientTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(VrvConfigRestClient.class);
    private static final String TOKEN = "fc5db3b3-4063-4a12-a511-880ba19e4b58";
    private static final String URL = "http://localhost:8818/api/v2/vrvconfigs";
    ...
    public void testList(){
         assertRequest(new Assertable() {
            ...
            public void assertBlack(RestResult restResult) throws Exception {
                RestResult<List<VrvConfig>> result = (RestResult<List<VrvConfig>>)restResult;
                ...
                LOGGER.info("VrvConfig list:{}", JSON.toJSON(restResult));
            }
        }, URL, VrvConfigRestClient.TOKEN);
    }


//    @Test(expected = ProcessingException.class)
//    public void testCreate(){
//        final VrvConfig vrvConfig = new VrvConfig();
////        vrvConfig.set*("*");
//
//        Response response = getBuilder(URL, vrvConfigRestClient.TOKEN).post(Entity.entity(vrvConfig, MediaType.APPLICATION_JSON));
//
//        assertRequest(new Assertable() {
//            @Override
//            public void assertBlack(RestResult restResult) throws Exception {
